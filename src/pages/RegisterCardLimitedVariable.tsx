...
// Mock data del link de pago - Suscripción limitada con monto variable
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Breadcrumb className="mb-6">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Limitada - Monto Variable</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-card/90 backdrop-blur-sm border-2 border-primary/30 rounded-lg p-3 space-y-1 shadow-soft">
                      <div className="flex justify-between text-sm">
                        <span className="text-foreground/80">Número de pagos:</span>
                    ...
                    {/* Información específica para suscripción limitada con monto variable */}
